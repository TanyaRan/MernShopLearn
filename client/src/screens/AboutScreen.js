    ...
    <>
      ...
      <div className='text-center'>
        ...
        <h4>
          ...
          services for their active vacation in the mountains.
        </h4>
        <h5>
        ...
        <h5>
          We revived the children's suburban camps and created the Mountain
          School "Wild Goats", which enjoys great interest among children. We
          also organize mountain children's camps, where children learn
          knowledge and skills about living in the mountains.
        </h5>
        <LinkContainer to='/'>
